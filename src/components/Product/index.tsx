...
import prodSlide1 from "../../assets/img/prodslide1.jpg";
import prodSlide2 from "../../assets/img/prodslide2.jpg";
import prodSlide3 from "../../assets/img/prodslide3.jpg";
import prodSlide4 from "../../assets/img/prodslide4.jpg";
...
export function Product() {
  ...
  return (
    <Box h={{ base: "1300px", xl: "1500px", "2xl": "1900px" }} bg="white">
          ...
          <Box {...textBoxProps}>
            ...
            >
              ...
              <VStack {...textStackProps}>
                ...
                <Text {...slideTextProps}>
                  O app para técnica permite a coleta da anamnese diretamente
                  pelo celular no momento da entrevista.
                </Text>
              </VStack>
              <VStack {...textStackProps}>
                <Heading {...slideHeadingProps}>
                ...
                <Text {...slideTextProps}>
                  Os laudos estruturados podem gerar relatórios para
                  preenchimento no sistema do SISCAN.
                </Text>
              </VStack>
            </Slider>
          </Box>
